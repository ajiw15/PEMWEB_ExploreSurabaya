  	 	...
  	 	<div class="row">
  	 		<div class="col-md-6">
  	 			<div class="form-group">
					...
					<input type="text" name="nama_wisata" placeholder="Masukkan Nama Wisata" class="form-control" value="<?php  echo $destinasi['nama_wisata'];?>">
					<small class="form-text text-danger"><?php echo form_error('nama_wisata'); ?></small> 
				</div>
				<div class="form-group">
					<label>Deskripsi</label>
					<input type="text" name="deskripsi" placeholder="Masukkan Deskripsi" class="form-control" value="<?php  echo $destinasi['deskripsi'];?>">
					<small class="form-text text-danger"><?php echo form_error('deskripsi'); ?></small> 
				</div>
				<div class="form-group">
					<label>Kategori</label>
					<select name="kode_kategori" class="form-control">
						<option value="<?php  echo $destinasi['kode_kategori'];?>">--Pilih Kategori Wisata--</option>
					...
					<select name="kode_fasilitas" class="form-control">
						<option value="<?php  echo $destinasi['kode_fasilitas'];?>">--Pilih Fasilitas Wisata--</option>
  	 		...
  	 		<div class="col-md-6">
				<div class="form-group">
					<label>Masukkan Waktu Buka:</label>
 					 <input type="time" id="buka" name="buka" placeholder="Masukkan Waktu Buka" class="form-control" value="<?php  echo $destinasi['buka'];?>">
					<small class="form-text text-danger"><?php echo form_error('buka'); ?></small>
				</div>
				<div class="form-group">
					<label>Masukkan Waktu Tutup:</label>
 					 <input type="time" id="tutup" name="tutup" placeholder="Masukkan Waktu Tutup" class="form-control" value="<?php  echo $destinasi['tutup'];?>">
					<small class="form-text text-danger"><?php echo form_error('tutup'); ?></small>
				</div><br><br><br>
				<button type="submit" name="ubah" class="btn btn-primary float-right mt-5">Edit Data</button>
  	 		</div>
  	 	</div>
    </form>
  </div>
